function drawmap() {
    ...
    d3.json("http://localhost:3000/posts", function(error, data) {
            data['language'] = 'sv';
            d3.json("/v3/tonality?apiKey=56400356154240e209e88dc839585e15")
                .header("Content-Type", "application/json")
                .post(JSON.stringify(data), function(err, rawData) {
                        data = rawDatas,
                        ...
                        cellSize_h = 20,
                        height = cellSize_h * rowLabel.length + margin.bottom,
                        legendElementWidth = width / 11 - 1,
                        legendElementHeight = cellSize_h / 2,
                        colors = cbrewer.Reds[9],
